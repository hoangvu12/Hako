...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::editor::trim_clip,
            commands::editor::clip_audio_tracks,
            commands::editor::read_clip_range,
            commands::editor::remux_with_tracks,
            commands::get_settings,
            commands::update_settings,
            commands::storage::count_clips_in,
            commands::storage::migrate_clips_to,
